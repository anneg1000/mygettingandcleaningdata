...
trainx <- read.table("mydata/UCI HAR Dataset/train/X_train.txt")
testx  <- read.table("mydata/UCI HAR Dataset/test/X_test.txt" )
featuredata <- rbind(trainx, testx)

trainy <- read.table("mydata/UCI HAR Dataset/train/Y_train.txt")
testy  <- read.table("mydata/UCI HAR Dataset/test/Y_test.txt")
activitydata <- rbind(trainy, testy)

trains <- read.table("mydata/UCI HAR Dataset/train/subject_train.txt")
tests  <- read.table("mydata/UCI HAR Dataset/test/subject_test.txt")
...
activitylabels <- read.table("mydata/UCI HAR Dataset/activity_labels.txt")
